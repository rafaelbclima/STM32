...
- **F446_TimerPooling**: Medição do tempo de execução de um código qualquer, fazendo a diferença entre dois instates de um timer. (<ins>Nucleo STM32F446RE</ins>)
- **F446_TimerCaptura**: Medição do período de uma onda quadrada utilizando o modo captura. (<ins>Nucleo STM32F446RE</ins>)
- **F446_TimerPWM**: Geração de um PWM com dutycycle variável, através de um timer. (<ins>Nucleo STM32F446RE</ins>)
...
- **F446_SWV**: Testes das ferramentas de debug avançadas. (<ins>Nucleo STM32F446RE</ins>)
